...
<TR>
<TD colspan="2" valign="top"><em>Approving Official</em><br />Approved (#DateFormat(aDate , "mm/dd/yyyy")#)</TD>
<TD colspan="2" valign="top">
#aUser#<br>
...
<TR>
<TD colspan="4">
<em>Fiscal Officer</em><br />Approved (#DateFormat(fDate, "mm/dd/yyyy")#)<br />
</TD>
</TR>
<TR>
<TD colspan="4">Comments: #fComment#</TD>
</TR>
<cfform action="processDReviewBlanket.cfm" method="post" name="memo">
<TR>
<TD colspan="4">
