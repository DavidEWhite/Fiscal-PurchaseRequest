...
SELECT recordID, rDate, service, aTrigger, fTrigger
FROM SinglePurchase
WHERE ((aTrigger=1) AND (fTrigger=0))
ORDER BY recordID;
</cfquery>
...
<TD ALIGN="center" WIDTH="50%">
	<H3>Bay Pines VA Healthcare System<BR>Approval Request for Food & Beverage<br>Purchases Using a Government<br>Purchase Card<BR>Fiscal Officer Review</H3>
	</TD>
	<TD WIDTH="25%" VALIGN="top">
...
<TR>
<TD ALIGN="center"><a href="fReviewSingle.cfm?recordID=#recordID#">#recordID#</a></TD>
...
<TR>
<TD ALIGN="center"><a href="fReviewBlanket.cfm?recordID=#recordID#">#recordID#</TD>
<TD>#DateFormat(rDate , "mm/dd/yyyy")#</TD>
<TD>#service#</TD>
</TR>
</cfoutput>
