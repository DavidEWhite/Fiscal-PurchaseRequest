...
<cfform action="reviewDuplicateBlanket.cfm" method="post" name="memo">
...
<TD><cfinput type="text" name="fcpgpf" message="Please provde the FCP/GPF this request is against." required="yes" class="textc" value="#fcpgpf#" size="5">
...
<cfinput type="text" name="amount" message="Please provide the cost in dollars and cents" required="yes" class="textc" value="#amount#">
...
<TD COLSPAN="3">
<CFIF IsDefined("gpfID")>
<cfinput type="text" name="gpfID" class="textb" value="#gpfID#" size="20">
<CFELSE>
...
<TD COLSPAN="3">
<cfinput type="text" name="fbType" message="Type of Food/Bev is a required field" required="yes" class="textc" value="#fbType#" size="70">
...
<TD>** Attendees:</TD>
<TD COLSPAN="3">
<cfinput type="text" name="attendees" message="Attendees is a required field. Use N/A if not applicable." required="yes" class="textc" value="#attendees#" size="50">
...
<TD COLSPAN="3">
<cfinput type="text" name="attendees2" message="This field requires numbers only. Use 0 if not applicable." validateat="onSubmit" validate="integer" class="textc" value="#attendees2#" size="5">
...
<TD COLSPAN="2" valign="top"><cfinput type="text" name="remail" message="Email is a required field." required="yes" class="textc" value="#rEmail#" size="35" >
<INPUT type="hidden" name="rEmail_required" value="Requester email is a required field.">
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** Requestor email address<br>
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** Service Line</TD>
<TD COLSPAN="2"><cfinput type="text" name="aEmail" message="Email is a required field." required="yes" class="textc" value="#aEmail#" size="35" >
