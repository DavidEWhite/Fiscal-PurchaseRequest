...
<BODY onLoad="document.memo.fComment.focus()">
<!--- Heading table --->
...
<TR>
<TH COLSPAN="3" style="font-variant:small-caps">- - - Review by Fiscal Officer - - -</TD>
</TR>
<TR>
<TD COLSPAN="3">
...
<TR>
<TD colspan="2" valign="top"><em>Approving Official</em><br/>
Approved (#DateFormat(aDate , "mm/dd/yyyy")#)</TD>
<TD colspan="2" valign="top">
#aUser#<br>
...
<cfform action="processFReviewBlanket.cfm" method="post" name="memo">
<TR>
<TD colspan="4">
<h1 align="center">Fiscal Officer </h1> 
Comments <em style="font-size:10px">(limit 250 characters)</em>:<br />
<TEXTAREA rows="3" cols="90" name="fComment" id="maxcharfield" 
...
<TR>
<TD colspan="2"><input name="fTrigger" type="radio" value="1" checked> Approve</TD>
<TD colspan="2"><input name="fTrigger" type="radio" value="2"> Disapprove</TD>
</TR>
<TR>
