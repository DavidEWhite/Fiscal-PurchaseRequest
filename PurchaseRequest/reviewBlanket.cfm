...
IsDefined("FORM.option6") OR IsDefined("FORM.option7") OR IsDefined("FORM.option8") OR IsDefined("FORM.option9") OR IsDefined("FORM.option10")>
...
<cfform action="processBlanket.cfm" method="post" name="memo">
