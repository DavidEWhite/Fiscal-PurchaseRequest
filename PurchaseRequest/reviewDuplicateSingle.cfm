...
<cfform action="processDuplicateSingle.cfm" method="post" name="memo"><CFOUTPUT>
<TABLE width="100%" border="0">
<TR>
<TD style="color:##000080; font-size:13px; font-family:'Times New Roman', Times, serif">Date:</TD>
<TD COLSPAN="2">#FORM.rDate#</TD>
</TR>
<TR>
...
<TD COLSPAN="3">#DateFormat(FORM.eDate , "mm/dd/yyyy")#
</TD>
</TR>
<TR>
<TD>** Location:</TD>
...
<cfinput name="partiesOther" type="text" class="textb" value="#FORM.partiesOther#"></TD>
</TR>
<TR>
...
<TD COLSPAN="2" VALIGN="top">OTHER <em style="font-size:10px">(please describe)</em>: 
<cfinput name="typeOther" type="text" class="textb" value="#FORM.typeOther#"></TD>
</TR>
<TR>
<TD COLSPAN="4">
...
<TR>
<TD COLSPAN="4">Date of Request: <strong>#DateFormat(FORM.rDate , "mm/dd/yyyy")#</strong></TD>
</TR>
<TR>
<TD COLSPAN="2" valign="top">
...
<TD COLSPAN="2" valign="top">
<cfinput type="text" name="remail" message="Email is a required field." required="yes" class="textc" value="#FORM.rEmail#" size="35" >
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;** Service Line</TD>
<TD COLSPAN="2">
<cfinput type="text" name="aEmail" message="Email is a required field." required="yes" class="textc" value="#FORM.aEmail#" size="35" >
