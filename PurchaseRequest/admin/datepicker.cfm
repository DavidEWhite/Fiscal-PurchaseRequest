...
<cfparam name="attributes.first_use_on_page" default="yes">
<cfparam name="attributes.font" default="Arial,Helvetica,sans-serif"> 
<cfparam name="attributes.fontcolor" default="black">
<cfparam name="attributes.dayheadercolor" default="FFFFFF">
<cfparam name="attributes.monthcolor" default="FFFFFF">
<cfparam name="attributes.othermonthscolor" default="FFFFFF">
<cfparam name="attributes.selecteddaycolor" default="FFFFC0">
<cfparam name="attributes.backcolor" default="FFFFFF">
<cfparam name="attributes.language" default="english">
<cfparam name="attributes.hidedivname" default="">
<cfparam name="attributes.displayorientation" default="center">
...
<cfif attributes.first_use_on_page eq "yes">
  ...
  <cfoutput>
   ...
   <STYLE type="text/css">	
    ...
    .enterbox {background-color: mistyrose; color:##00000}
    .leavebox {background-color: mistyrose; color:}
...
//-->
 ...
 <cfoutput>
  ...
  <table border="0">
	<tr>
	<td> <input id="#attributes.textboxname#" type="text" name="#attributes.textboxname#" value="#attributes.initialvalue#" size="10" onFocus="this.className ='enterbox'" onBlur="isDate(this,'#attributes.dateorder#');this.className ='leavebox'" class="textc">
    </td>
    <td>
         ...
         <cfif attributes.image neq "">
           <img src="#attributes.image#" border="0" alt="">
         <cfelse>
          &nbsp;&nbsp;&nbsp;&nbsp;
         </cfif>
           </font></a></layer>
...
<script language="JavaScript1.2">
 ...
 <cfif attributes.language eq "english">
  ...
  <cfelseif attributes.language eq "spanish"> 
     var dayName = new Array ("dom", "lun", "mar", "mié", "jue", "vie", "sáb");
